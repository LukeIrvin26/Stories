!function(e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            ...
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t)
                return u || (u = s ? e[a] = V.pop() || it.guid++ : a),
                l[u] || (l[u] = s ? {} : {
                    toJSON: it.noop
                }),
    ...
    function E(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            nt.html5Clone && e.innerHTML && !it.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Dt.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function C(e) {
        var t = ht
          , n = Zt[e];
        return n || (n = k(e, t),
        "none" !== n && n || (Qt = (Qt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
    ...
    function A(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            ...
            "" === r.style.display && At(r) && (o[a] = it._data(r, "olddisplay", C(r.nodeName)))) : (i = At(r),
    ...
    function O(e, t, n) {
        ...
        u = it.css(e, "display"),
        c = "none" === u ? it._data(e, "olddisplay") || C(e.nodeName) : u,
        "inline" === c && "none" === it.css(e, "float") && (nt.inlineBlockNeedsLayout && "inline" !== C(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
    ...
    var ut = function(e) {
        ...
        var x, w, T, E, k, C, S, N, A, j, D, L, H, _, q, F, O, R, M, B = "sizzle" + -new Date, P = e.document, I = 0, $ = 0, W = n(), z = n(), X = n(), U = function(e, t) {
            return e === t && (D = !0),
            0
        }
        , G = "undefined", V = 1 << 31, Y = {}.hasOwnProperty, J = [], K = J.pop, Q = J.push, Z = J.push, et = J.slice, tt = J.indexOf || function(e) {
        ...
        ;
        try {
            Z.apply(J = et.call(P.childNodes), P.childNodes),
        ...
        L = t.setDocument = function(e) {
            ...
            (w.qsa = vt.test(n.querySelectorAll)) && (i(function(e) {
                ...
                e.querySelectorAll("[msallowclip^='']").length && F.push("[*^$]=" + rt + "*(?:''|\"\")"),
            ...
            i(function(e) {
                ...
                e.querySelectorAll("[name=d]").length && F.push("name" + rt + "*[*^$|!~]?="),
            ...
            M = t || vt.test(_.contains) ? function(e, t) {
            ...
            U = t ? function(e, t) {
                ...
                1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === P && M(P, e) ? -1 : t === n || t.ownerDocument === P && M(P, t) ? 1 : j ? tt.call(j, e) - tt.call(j, t) : 0 : 4 & r ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return D = !0,
        ...
        T = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return ht.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && ft.test(n) && (t = C(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
                    ...
                    : function(t, n, l) {
                        ...
                        if (g) {
                            ...
                            a && y) {
                                ...
                                for (; (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[B] || (d[B] = {}))[e] = [I, f]),
                                d !== t)); )
                                    ;
                            return f -= i,
                            f === r || f % r === 0 && f / r >= 0
        ...
        N = t.select = function(e, t, n, r) {
            ...
            return (u || S(e, d))(r, t, !q, n, bt.test(e) && c(t.parentNode) || t),
            n
        }
        ,
    ...
    : function(e, t, n) {
        var r = "on" + t;
        e.detachEvent && (typeof e[r] === Et && (e[r] = null ),
        e.detachEvent(r, n))
    }
    ,
    ...
    it.extend({
        clone: function(e, t, n) {
            ...
            if (nt.html5Clone || it.isXMLDoc(e) || !Mt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Kt.innerHTML = e.outerHTML,
            ...
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                o || 0 === o)
                    if ("object" === it.type(o))
                        ...
                        l = (It.exec(o) || ["", ""])[1].toLowerCase(),
                        c = Yt[l] || Yt._default,
                        s.innerHTML = c[1] + o.replace(Pt, "<$1></$2>") + c[2],
                        i = c[0]; i--; )
                            s = s.lastChild;
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, s = it.expando, l = it.cache, u = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
                ...
                o = i && l[i])) {
                    ...
                    l[i] && (delete l[i],
                    u ? delete n[s] : typeof n.removeAttribute !== Et ? n.removeAttribute(s) : n[s] = null ,
                    V.push(i))
                }
        }
    }),
        ...
        domManip: function(e, t) {
            ...
            n)) {
                ...
                if (i)
                    ...
                    l = 0; i > l; l++)
                        r = o[l],
                        Ut.test(r.type || "") && !it._data(r, "globalEval") && it.contains(a, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Vt, "")));
                s = n = null
            }
            return this
        }
    ...
    it.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === Et ? it.prop(e, t, n) : (1 === o && it.isXMLDoc(e) || (t = t.toLowerCase(),
                r = it.attrHooks[t] || (it.expr.match.bool.test(t) ? En : Tn)),
        ...
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++]; )
                    r = it.propFix[n] || n,
                    it.expr.match.bool.test(n) ? Nn && Sn || !Cn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""),
    ...
    En = {
        set: function(e, t, n) {
            return t === !1 ? it.removeAttr(e, n) : Nn && Sn || !Cn.test(n) ? e.setAttribute(!Sn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
        ...
        addClass: function(e) {
            ...
            if (u)
                for (t = (e || "").match(bt) || []; l > s; s++)
                    if (n = this[s],
                    r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Dn, " ") : " ")) {
                        for (o = 0; i = t[o++]; )
                            r.indexOf(" " + i + " ") < 0 && (r += i + " ");
                        a = it.trim(r),
        ...
        toggleClass: function(e, t) {
            ...
            : function() {
                if ("string" === n)
                    ...
                    (n === Et || "boolean" === n) && (this.className && it._data(this, "__className__", this.className),
    ...
    ;
    var qn, Fn, On = /#.*$/, Rn = /([?&])_=[^&]*/, Mn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Bn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Pn = /^(?:GET|HEAD)$/, In = /^\/\//, $n = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wn = {}, zn = {}, Xn = "*/".concat("*");
    try {
        Fn = location.href
    } catch (Un) {
    ...
    it.extend({
        ...
        ajax: function(e, t) {
            ...
            w.success = w.done,
            w.error = w.fail,
            d.url = ((e || d.url || Fn) + "").replace(On, "").replace(In, qn[1] + "//"),
            ...
            delete d.data),
            d.cache === !1 && (d.url = Rn.test(o) ? o.replace(Rn, "$1_=" + Ln++) : o + (Hn.test(o) ? "&" : "?") + "_=" + Ln++)),
    ...
    it.fn.extend({
        offset: function(e) {
            ...
            if (o)
                ...
                it.contains(t, i) ? (typeof i.getBoundingClientRect !== Et && (r = i.getBoundingClientRect()),
                n = G(o),
                {
...
function(e, t) {
    ...
    r.delegate(n.formSubmitSelector, "submit.rails", function(r) {
        ...
        if (!n.allowAction(a))
            return n.stopEverything(r);
        if (a.attr("novalidate") == t && (i = n.blankInputs(a, n.requiredInputSelector),
...
function() {
    ...
    Q = function(e) {
        var t;
        return t = _[e],
        t && !t.transitionCacheDisabled ? t : void 0
    }
    ,
    x = function(e) {
        return null == e && (e = !0),
    ...
    b = function(e) {
        return null == e && (e = !0),
        u ? e ? null != M ? M : M = new o("html") : (null != M && M.uninstall(),
        M = null ) : void 0
    }
    ,
    C = function(e, t, n) {
        ...
        tt.open("GET", e.withoutHashForIE10compatibility(), !0),
        tt.setRequestHeader("Accept", "text/html, application/xhtml+xml, application/xml"),
        tt.setRequestHeader("X-XHR-Referer", I),
        tt.onload = function() {
            var n;
            return Z(r.RECEIVE, {
                url: e.absolute
            ...
            H(),
            "function" == typeof t && t(),
            Z(r.LOAD)) : document.location.href = v() || e.absolute
        }
        ,
        M && n && (tt.onprogress = function() {
            return function(e) {
                var t;
                return t = e.lengthComputable ? e.loaded / e.total * 100 : M.value + (100 - M.value) / 10,
                M.advanceTo(t)
            }
        }(this)),
    ...
    m = function(e) {
        ...
        o = a.length; o > n; n++)
            i = a[n],
            _[i].cachedAt <= t[e] && (Z(r.EXPIRE, _[i]),
            s.push(delete _[i]));
        return s
    }
    ,
    p = function(t, n, i, o) {
        return Z(r.BEFORE_UNLOAD),
        document.title = t,
    ...
    J = function() {
        var e, t;
        return e = (t = document.querySelectorAll("input[autofocus], textarea[autofocus]"))[t.length - 1],
    ...
    W = function() {
        var e, t;
        return (e = tt.getResponseHeader("X-XHR-Redirected-To")) ? (e = new n(e),
        t = e.hasNoHash() ? document.location.hash : "",
        window.history.replaceState(window.history.state, "", e.href + t)) : void 0
    }
    ,
    v = function() {
        var e;
    ...
    H = function() {
        var e;
        return navigator.userAgent.match(/Firefox/) && !(e = new n).hasNoHash() ? (window.history.replaceState(y, "", e.withoutHash()),
        document.location.hash = e.hash) : void 0
    }
    ,
    B = function(e) {
    ...
    R = function() {
        ...
        r = function(e) {
            var t, n, r, i, o;
            for (i = e.querySelector("head").childNodes,
            o = [],
            t = 0,
            n = i.length; n > t; t++)
                r = i[t],
                null != ("function" == typeof r.getAttribute ? r.getAttribute("data-turbolinks-track") : void 0) && o.push(r.getAttribute("src") || r.getAttribute("href"));
            return o
        }
        ,
        e = function(e) {
            ...
            t = r(e),
            t.length !== L.length || i(t, L).length !== L.length
        }
        ,
        i = function(e, t) {
            var n, r, i, o, a;
            for (e.length > t.length && (i = [t, e],
            e = i[0],
            t = i[1]),
            o = [],
            n = 0,
            r = e.length; r > n; n++)
                a = e[n],
                nt.call(t, a) >= 0 && o.push(a);
            return o
        }
        ,
        !t() && o() && (n = g(tt.responseText),
        n && !e(n)) ? n : void 0
    }
    ,
    T = function(t) {
        ...
        [null != n ? n.textContent : void 0, G(t.querySelector("body")), e.get(t).token, "runScripts"]
    }
    ,
    e = {
        get: function(e) {
        ...
        update: function(e) {
            var t;
            return t = this.get(),
            null != t.token && null != e && t.token !== e ? t.node.setAttribute("content", e) : void 0
        }
    },
    g = function(e) {
        var t;
    ...
    i = function(e) {
        ...
        t.allowExtensions = function() {
            var e, n, r, i;
            for (n = 1 <= arguments.length ? ot.call(arguments, 0) : [],
            r = 0,
            i = n.length; i > r; r++)
                e = n[r],
    ...
    t = function() {
        function e(e) {
            ...
            this._validForTurbolinks() && (q(this.link.absolute) || et(this.link.href),
            this.event.preventDefault()))
        }
        return e.installHandlerLast = function(t) {
            return t.defaultPrevented ? void 0 : (document.removeEventListener("click", e.handle, !1),
    ...
    o = function() {
        function e(e) {
            ...
            this._trickle = at(this._trickle, this),
            this.value = 0,
            this.content = "",
            this.speed = 300,
            this.opacity = .99,
    ...
    j = function(e) {
        var t, r;
        return (null != (r = e.state) ? r.turbolinks : void 0) ? (t = _[new n(e.state.url).absolute]) ? (d(),
        k(t)) : et(e.target.location.href) : void 0
    }
    ,
    N = function() {
        return X(),
    ...
    ,
    S = void 0 !== window.history.state || navigator.userAgent.match(/Firefox\/2[6|7]/),
    l = window.history && window.history.pushState && window.history.replaceState && S,
    a = !navigator.userAgent.match(/CriOS\//),
    V = "GET" === (P = O("request_method")) || "" === P,
    u = l && a && V,
